...
public class PayloadVerifierTest {
  ...
  @Test
  public void testBagWithAccentedCharactersInFilenameIsValid() throws Exception {
    Path bagDir = Paths.get(new File("src/test/resources/nonLatinCharactersInFilename").toURI());
    Bag bag = reader.read(bagDir);
    sut.verifyPayload(bag, true);
  }
}
